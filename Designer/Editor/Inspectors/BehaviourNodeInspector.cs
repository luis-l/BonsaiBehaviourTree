...
namespace Bonsai.Designer
{
  ...
  public class BehaviourNodeInspector : Editor
  {
    ...
    protected virtual void OnEnable()
    {
      ...
      if (ParentWindow.Editor.EditorMode.Value == BonsaiEditor.Mode.View)
      {
    ...
    public override bool RequiresConstantRepaint()
    {
      ...
      return ParentWindow.Editor.EditorMode.Value == BonsaiEditor.Mode.View && runtimeFields.Count != 0;
    }
